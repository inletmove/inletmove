...
const VIEWS: Record<View, { title: string; titleEm: string; list: string[]; iconClass: string; icon: string }> = {
  old: {
    title: 'How a move',
...
export default function CompareToggle() {
  ...
  return (
    <section aria-label="Compare" className="bg-bone px-6 py-24 md:px-8 md:py-32">
      <div className="mx-auto max-w-container">
        <div className="mb-10 max-w-2xl">
          ...
          <h2 className="font-display text-display-2 font-medium leading-tight tracking-tight text-inlet-navy display-soft">
            Two ways to{' '}
            <em className="display-italic text-ember">move.</em>
          </h2>
        </div>
        ...
        <div className="rounded-xl border border-line-light bg-paper p-8 transition-opacity duration-300 md:p-10">
          <h3 className="mb-5 font-display text-3xl font-medium leading-tight tracking-tight text-inlet-navy display-soft">
            {v.title}{' '}
            <em className="display-italic text-ember">{v.titleEm}</em>
          </h3>
